...
int		main(void)
{
	...
	t_box	*bar1    __attribute__((unused)) = bar_hover_on_option(program, "About", MOVE_DOWN);
	t_box	*bar2    __attribute__((unused)) = bar_hover_on_option(bar1, "Preferences", MOVE_DOWN);
